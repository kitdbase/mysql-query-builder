 ...
 */
class TableQuery {
    conection; // Tipo de conexión, puedes reemplazar `any` con el tipo adecuado
    nextType; // Almacenar el tipo para la próxima condición
    joins; // Almacenar los JOINs
    _orderBy; // Almacenar los ORDER BY
    _distinct; // Para controlar si se utiliza DISTINCT
    _groupBy; // Almacenar los GROUP BY
    tableName; // Nombre de la tabla
    fields; // Campos seleccionados
    query; // Consulta SQL construida
    conditions; // Condiciones WHERE
    limitValue = null; // Límite de resultados
    pageValue = null; // Límite de resultados
